  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        purple: "border-transparent bg-purple-100 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400",
        gradient: "border-transparent bg-gradient-to-r from-primary-600 to-secondary-600 text-white",
      },
    },
    defaultVariants: {
      variant: "default",
